...
/**
 * Deploys a contract named "VendingMachine" using the deployer account
 *
...
const deployVendingMachine: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  */
  ...
  const vendingMachine = await hre.ethers.getContract<Contract>("VendingMachine", deployer);
  console.log("VendingMachine deployed at:", vendingMachine.address);
};
